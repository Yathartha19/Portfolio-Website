...
export default function Hero() {
  return (
    <main className="min-h-screen w-full bg-[#0c0c0c] flex flex-col justify-between text-white">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between mx-30 mt-[22vh] pb-12 gap-16">
        
        <div className="flex flex-col gap-8 max-w-2xl pl-8">
          <h1 className="text-6xl md:text-7xl font-semibold tracking-tight">
            Yathartha Aarush
          </h1>

          <div className="flex flex-wrap gap-x-10 gap-y-3 text-sm tracking-widest text-gray-500 uppercase">
            <p>Web Developer</p>
            <p>SDE</p>
            <p>Startup Founder</p>
            <p>India</p>
          ...
          <p className="text-[1.4rem] text-gray-300 font-light leading-tight max-w-[45vw]">
        ...
        <div className="flex-1 flex justify-end w-full h-[50vh] md:h-[60vh]">
          <div className="w-full md:w-[25vw] rounded-md border border-white/40 bg-linear-to-t from-[#0a0a0a] to-[#101010] shadow-inner flex items-center justify-center">
            <div className="text-white/40 text-xs uppercase tracking-widest">
              what to do here man i cry
            </div>
          </div>
        </div>
      ...
      <section className="flex flex-row items-center justify-between px-30 py-6 text-white/60 text-sm ">
        ...
        <div className="flex items-center justify-center gap-2 hover:text-gray-300 transition-all duration-200 cursor-pointer">
          <span>Scroll</span>
