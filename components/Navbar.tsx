...
export default function navbar() {
    return (
        <nav className="w-screen h-[10vh] fixed text-white bg-[rgba(0,0,0,0)] backdrop-blur-lg z-50">
            ...
            <div className="mx-10 sm:mx-30 h-full flex flex-row items-center justify-between border-b border-white/40">
                <div className="text-white/85 max-sm:hidden roboto tracking-wide text-[1.2rem] hover:cursor-pointer transform transition-transform duration-200 ease-out hover:scale-102">
                    YATHARTHA AARUSH 
                </div>
                <div className="text-white/85 sm:hidden roboto tracking-wide text-[1.2rem] hover:cursor-pointer transform transition-transform duration-200 ease-out hover:scale-102">
                    YATHARTHA A.
                </div>
                <div className=" text-white/70 tracking-wide font-light max-lg:hidden">
                ...
                <div className="text-white/70 tracking-wide font-light lg:hidden">
                    <FaGripLines />
                </div>
            </div>
